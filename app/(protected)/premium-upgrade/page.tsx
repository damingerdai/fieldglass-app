  ...
  return (
    <>
      ...
      <p className="text-base text-slate-500 max-w-md mx-auto mb-10">
        We are crafting a powerful set of features to help you and your team
        manage leave and operations with ultimate efficiency.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left mb-12">
        <div className="p-5 rounded-2xl border border-dashed border-slate-200 bg-slate-50/50">
          ...
          <p className="text-xs text-slate-400">
            Deep dive into team attendance trends, custom reporting, and
        ...
        <div className="p-5 rounded-2xl border border-dashed border-slate-200 bg-slate-50/50">
          ...
          <p className="text-xs text-slate-400">
            Custom approval chains, smart notifications, and seamless calendar
            integrations.
          </p>
        </div>
        ...
        <div className="p-5 rounded-2xl border border-dashed border-slate-200 bg-slate-50/50">
          ...
          <p className="text-xs text-slate-400">
            SAML SSO, advanced audit logs, and granular role-based access
            control for your entire org.
          </p>
        </div>
        ...
        <div className="p-5 rounded-2xl border border-dashed border-slate-200 bg-slate-50/50 flex flex-col justify-center items-center text-center p-6">
          ...
          <h3 className="font-semibold text-[#7C3AED] text-sm mb-1">
            What do you need?
          </h3>
          <p className="text-xs text-slate-400">
            Your feedback shapes our roadmap. Tell us what features you want to
            see most!
          </p>
        </div>
      </div>
      ...
      <div className="max-w-md mx-auto">
        {!submitted ? (
          ...
          <div className="p-4 rounded-xl bg-emerald-50 text-emerald-700 text-sm font-medium animate-fade-in">
            🎉 Thanks! We'll keep you updated and reach out for your feedback
            soon.
          </div>
        )}
      </div>
