...
export function CreateLeaveEntitlementsForm({
  className,
  ...props
  ...
  const leaveTypes = [
    {
      id: 'annual',
      label: 'Annual Leave',
      desc: 'Paid time off for holidays and personal use'
    },
    {
      id: 'sick',
      label: 'Sick Leave',
      desc: 'For medical appointments and recovery'
    },
    {
      id: 'unpaid',
      label: 'Unpaid Leave',
      desc: 'Leave without salary compensation'
    }
